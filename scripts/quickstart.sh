...
# Default example: microwave_7221, scene_0, 10 episodes.
...
python tools/assets/prepare_scene_pipeline.py --scene-name scene_0
...
python scripts/plan.py object_id=7221 scene_name=scene_0 mode=train
python scripts/plan.py object_id=7221 scene_name=scene_0 mode=test
...
bash scripts/run_pipeline.sh plan 7221 scene_0 test
...
bash scripts/run_pipeline.sh record microwave_7221 scene_0 10 --headless

# Record with explicit trajectory and output HDF5 paths.
bash scripts/run_pipeline.sh record microwave_7221 scene_0 10 \
  --traj_file data/trajs/summit_franka/microwave_7221/scene_0/train/traj_data_train.pt \
  --dataset_file data/automoma/summit_franka_open-microwave_7221-scene_0-10.hdf5 \
  --headless

# Record one HDF5 per episode instead of one merged file.
bash scripts/run_pipeline.sh record microwave_7221 scene_0 10 \
  --split_episodes \
  --dataset_file data/automoma/summit_franka_open-microwave_7221-scene_0-10 \
  --headless
...
bash scripts/run_pipeline.sh replay microwave_7221 scene_0 4 --headless
...
bash scripts/run_pipeline.sh replay microwave_7221 scene_0 1 \
  --no-headless \
  --enable_cameras \
  --episode_indices 0
...
bash scripts/run_pipeline.sh debug microwave_7221 scene_0 \
  --debug_file data/trajs/summit_franka/microwave_7221/scene_0/train/grasp_0000/ik_data.pt
bash scripts/run_pipeline.sh debug microwave_7221 scene_0 \
  --debug_file data/trajs/summit_franka/microwave_7221/scene_0/train/grasp_0000/traj_data.pt
bash scripts/run_pipeline.sh debug microwave_7221 scene_0 \
  --debug_file data/trajs/summit_franka/microwave_7221/scene_0/train/traj_data_train.pt

# =============================================================================
# 4. Dataset conversion and visualization
# =============================================================================
# Convert raw AutoMoMa HDF5 to LeRobot format.
bash scripts/run_pipeline.sh convert lerobot microwave_7221 scene_0 10
...
bash scripts/run_pipeline.sh convert lerobot microwave_7221 scene_0 10 \
  ...
  --hdf5_name summit_franka_open-microwave_7221-scene_0-10.hdf5 \
  --repo_id automoma/summit_franka_open-microwave_7221-scene_0-10 \
  --output_dir data/lerobot/automoma/summit_franka_open-microwave_7221-scene_0-10

# Visualize a LeRobot dataset.
lerobot-dataset-viz \
  --repo-id automoma/summit_franka_open-microwave_7221-scene_0-10 \
  --root data/lerobot/automoma/summit_franka_open-microwave_7221-scene_0-10 \
  --episode-index 0 \
  --video-backend pyav
...
python tools/dataset/convert_hdf5_layout.py \
  data/automoma/summit_franka_open-microwave_7221-scene_0-10.hdf5 \
  data/automoma/summit_franka_open-microwave_7221-scene_0-10-split \
  --direction split \
  --mode copy \
  --overwrite
python tools/dataset/convert_hdf5_layout.py \
  data/automoma/summit_franka_open-microwave_7221-scene_0-10-split \
  data/automoma/summit_franka_open-microwave_7221-scene_0-10-merged.hdf5 \
  --direction merge \
  --mode copy \
  --overwrite
...
bash scripts/run_pipeline.sh train lerobot act microwave_7221 scene_0 10
bash scripts/run_pipeline.sh train lerobot diffusion microwave_7221 scene_0 10

# Short smoke training run with custom output directory and wandb disabled.
WANDB_MODE=disabled bash scripts/run_pipeline.sh train lerobot act microwave_7221 scene_0 10 \
  --dataset.repo_id automoma/summit_franka_open-microwave_7221-scene_0-10 \
  --dataset.root data/lerobot/automoma/summit_franka_open-microwave_7221-scene_0-10 \
  --output_dir outputs/train/smoke/act_microwave_7221_scene_0_10 \
  --job_name act_microwave_7221_scene_0_smoke \
  --steps 10 \
  --batch_size 2 \
  --wandb.enable=false

# Evaluate a trained LeRobot policy. Base actions are absolute by default.
bash scripts/run_pipeline.sh eval lerobot act microwave_7221 scene_0 10 --headless

# Evaluate with explicit checkpoint, test trajectory, and output directory.
bash scripts/run_pipeline.sh eval lerobot act microwave_7221 scene_0 10 \
  --policy.path outputs/train/lerobot/act_summit_franka_open-microwave_7221-scene_0-10/checkpoints/last/pretrained_model \
  --traj_file data/trajs/summit_franka/microwave_7221/scene_0/test/traj_data_test.pt \
  --output_dir outputs/eval/lerobot/act_summit_franka_open-microwave_7221-scene_0-10 \
  --headless \
  --eval.n_episodes=10

# Evaluate a recorded HDF5 dataset with the runtime eval rule.
bash scripts/run_pipeline.sh record_dataset_eval microwave_7221 scene_0 10 \
  --dataset_file data/automoma/summit_franka_open-microwave_7221-scene_0-10.hdf5 \
  --traj_file data/trajs/summit_franka/microwave_7221/scene_0/test/traj_data_test.pt \
  --output_dir outputs/eval/record_dataset/microwave_7221_scene_0_10 \
  --headless
...
python tools/debug/plots/plot_action_trace_joint_states.py \
  --csv outputs/eval/lerobot/act_summit_franka_open-microwave_7221-scene_0-10/action_trace_joint_states.csv \
  --per_episode \
  --output_dir outputs/eval/lerobot/act_summit_franka_open-microwave_7221-scene_0-10/trace_plots
python tools/debug/plots/plot_ee_pose_trace.py \
  --trace_csv outputs/eval/lerobot/act_summit_franka_open-microwave_7221-scene_0-10/action_trace_joint_states.csv \
  --per_episode_csv outputs/eval/lerobot/act_summit_franka_open-microwave_7221-scene_0-10/per_episode_results.csv \
  --output_dir outputs/eval/lerobot/act_summit_franka_open-microwave_7221-scene_0-10/ee_pose_plots

# Compare record and eval artifacts for alignment debugging.
python tools/debug/eval_align/compare_record_eval.py \
  --dataset_file data/automoma/summit_franka_open-microwave_7221-scene_0-10.hdf5 \
  --eval_output_dir outputs/eval/record_dataset/microwave_7221_scene_0_10 \
  --output_dir outputs/eval_alignment/record_vs_eval
python tools/debug/eval_align/compare_policy_eval.py \
  --run policy=outputs/eval/lerobot/act_summit_franka_open-microwave_7221-scene_0-10 \
...
bash scripts/run_pipeline.sh convert robotwin microwave_7221 scene_0 10 --policy dp3

# Train/evaluate RoboTwin DP3 through the wrapper.
bash scripts/run_pipeline.sh train robotwin dp3 microwave_7221 scene_0 10 \
  --gpu_id 0 \
  --output_dir outputs/train/robotwin/dp3_microwave_7221_scene_0_10
bash scripts/run_pipeline.sh eval robotwin dp3 microwave_7221 scene_0 10 \
  --gpu_id 0 \
  --checkpoint_root outputs/train/robotwin/dp3_microwave_7221_scene_0_10 \
  --output_dir outputs/eval/robotwin/dp3_microwave_7221_scene_0_10
