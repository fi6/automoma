...
```bash
bash scripts/run_pipeline.sh record microwave_7221 scene_0 30 --headless
bash scripts/run_pipeline.sh replay microwave_7221 scene_0 4 --metrics
...
bash scripts/run_pipeline.sh train lerobot act microwave_7221 scene_0 30
bash scripts/run_pipeline.sh eval lerobot act microwave_7221 scene_0 30 --headless
```
...
python tools/assets/prepare_scene_pipeline.py --scene_name scene_0
```
