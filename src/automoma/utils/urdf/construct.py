...
def attach_object_to_robot(
    ...
    inversed_object_urdf = inverse_object(object, "world", "door")
...
if __name__ == "__main__":
    ...
    urdf = URDFAsset("/home/xinhai/Documents/cuakr-docker/src/cuakr/urdf/test/7221/mobility.urdf")
    new_urdf_asset = inverse_object(
        urdf, "base", "link_0"
    )  # tip link is the link that will be attached to the robot
    new_urdf_asset._model.write_xml_file("/home/xinhai/Documents/cuakr-docker/src/cuakr/urdf/test/7221/mobility_inversed.urdf")
    robot_urdf = URDF.load(
        # "/home/yida/projects/cuakr-docker/assets/robot/robot/summit_franka/summit_franka.urdf"
        "/home/xinhai/Documents/cuakr-docker/assets/robot/robot/summit_franka/summit_franka.urdf"
    )
...
if __name__ == "__main_2_":
    ...
    new_urdf_asset._model.write_xml_file("output/temp/kitchen/inversed_refrigerator.urdf")
    ...
    #     urdf, robot_urdf, grasp_pose, "door", "ee_link", object_cfg={"door_joint": 0.0}
    # )
    ...
    # scene.subscene(["object"]).export("output/test/attached_object_scene.urdf")
