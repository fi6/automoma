...
class ScenePipeline:
    ...
    def generate_scene(self, objects: list[ObjectDescription], seed: int) -> SceneDescription:
        ...
        if self.generator == "infinigen":
            ...
            raise ValueError(f"Unknown scene generator: {self.generator}")

        return scene, updated_objects


if __name__ == "__main__":
    objects = [ObjectDescription(asset_type="Microwave", asset_id="7221", scale=0.4, urdf_path="assets/object/Microwave/7221/mobility.urdf"), 
               ObjectDescription(asset_type="Dishwasher", asset_id="11622", scale=0.6, urdf_path="assets/object/Dishwasher/11622/mobility.urdf")]
    scene = ScenePipeline()
