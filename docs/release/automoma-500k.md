...
This document covers trajectory-only release tools for the public AutoMoMa-500k dataset.

## Batch plan

```bash
python tools/release/automoma-500k/plan_automoma_500k.py
```
...
```bash
python tools/release/automoma-500k/plan_automoma_500k.py -- planner.traj.batch_size=10
```
