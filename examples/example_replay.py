...
def demo_replay_only():
    ...
    scene_path = "/home/yida/projects/automoma/output/collect/infinigen_scene_100/scene_33_seed_33"
    ...
    replay_pipeline = ReplayPipeline(task, simulation_app, output_base_dir="output/collect/traj")
